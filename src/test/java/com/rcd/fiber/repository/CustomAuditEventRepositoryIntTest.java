...
import com.rcd.fiber.config.audit.AuditEventConverter;
import com.rcd.fiber.domain.PersistentAuditEvent;
...
import static com.rcd.fiber.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
